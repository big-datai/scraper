...
/home/ec2-user/apache-maven-3.3.3/bin/mvn exec:java -Dexec.mainClass="com.workers.main.KMain" -Dexec.args="2 google gupdate 54.225.122.3" >/home/ec2-user/work.log &
